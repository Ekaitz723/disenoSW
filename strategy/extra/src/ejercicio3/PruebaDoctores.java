...
public abstract class PruebaDoctores {
	...
	public static void main(int dias, int cantidadNinos, boolean porConsola, boolean verbose) {
		...
		Examinador examinador[] = new Examinador[cantidadDoctores];
		examinador[0] = new TrabajaDia15(new Oculista("Wang"));
		examinador[1] = new TrabajaDia28(new Logopeda("Fong"));
